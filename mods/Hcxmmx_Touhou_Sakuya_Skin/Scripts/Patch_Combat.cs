...
internal static class CombatManager_EndCombatInternal_Patch
{
    private static void Prefix(object __instance) 
    {
        ...
        string chosenVictoryVoice = "res://mods/Hcxmmx_Touhou_Sakuya_Skin/Audio/Vo_tedium_sakuya.wav";
        if (roomTypeStr == "Boss") chosenVictoryVoice = "res://mods/Hcxmmx_Touhou_Sakuya_Skin/Audio/Vo_beat_sakuya.wav"; 
        else if (roomTypeStr == "Elite") chosenVictoryVoice = "res://mods/Hcxmmx_Touhou_Sakuya_Skin/Audio/Vo_win_sakuya.wav";
